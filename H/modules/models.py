...
from sqlalchemy.orm import backref, relationship #Creates a pseudo column in the child table
from flask_login import UserMixin
from datetime import datetime

@login_manager.user_loader
def load_user(user_id):
    return User.query.get(user_id) #select * from user where user_id=user_id
...
class User(UserMixin, db.Model):
    ...
    background_image = db.Column(db.String(30), nullable=False, default='default_bg.jpg')
